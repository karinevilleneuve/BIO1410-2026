...
# (5) Nous validons que la somme est bien de 1 pour chacune des régions 
...
# (1) Trier nos données par region puis en fonction de l'abondance relative 
# (2) Pour chaque région, associer un numéro de 1 à x dans la nouvelle colonne "Order" (1 étant le plus abondant)
