...
Commencez pas créer un nouveau document de type R markdown oũ vous pouvez votre script avec ces commandes qui installerons puis chargerons les librairies que vous devriez avoir à utiliser et chargerons le tableau de données. 
...
# (2) Filter le tableau de données en inscrivant entre les guillements le nom de la scientifique 
```
...
# (5) Nous validons que la somme est bien de 1 pour chacune des régions (Source) 
...
3. Sélectionner `Choose file` et sélectionner le fihcier produits  
