...
library(forcats) # Pour transformer des variable en facteurs avec un order précis "fct_relevel"
...
library(ggtext) # Utiliser le format markdown dans les graphique (Genre en italique)
library(ggpubr) # Pour combiner des graphiques 
library(export) # Pour enregistrer des graphique des bonne qualité 
library(reshape2) # Formatter des matrice à partir de tableaux 
...
# Continuous - Identifions les 15 genres qui sont les plus abondant dans la mains et sous la langue. 
df_top = df_agg %>% 
