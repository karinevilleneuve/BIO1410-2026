...
```{r, eval=FALSE}
df = readRDS(gzcon(url("https://raw.githubusercontent.com/karinevilleneuve/BIO1410-2026/refs/heads/main/data/df.Rds")))
```
...
my_palette = readRDS(gzcon(url("https://raw.githubusercontent.com/karinevilleneuve/BIO1410-2026/refs/heads/main/data/colors_abondance_relative.Rds")))
